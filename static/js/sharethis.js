                        ...
                        if (typeof(res) !== "undefined") {
                          ...
                          if(res.status === "true") {
                            ...
                            try {
                              ...
                              var is_safari = /constructor/i.test(window.HTMLElement) 
                                || (function (p) { return p.toString() === "[object SafariRemoteNotification]"; })
                                (!window['safari'] || (typeof safari !== 'undefined' && window['safari'].pushNotification));
                              
                              // run lotame's panorama id code if indicated by the content rule
                              // and we're on firefox or safari
                              if(res.lotame === "true" && (is_firefox || is_safari)) {
                                !function() {
                                ...
                                window.__sharethis__.js("https://tags.crwdcntrl.net/lt/c/16621/sync.min.js")
                              }
                            } catch (e) {
                              // do nothing for now
                            }
...
(function(){window.__sharethis__.md5="3d3b59b356a084a7bf0c7279ed2fc118";})();